...
const Crud = () => {
    ...
    useEffect(() => {
        const fetchItems = async () => {
            try {
                const result = await axios.get('https://663e7a53e1913c476797c189.mockapi.io/exclusive');
    ...
    const createItem = async () => {
        try {
            const result = await axios.post('https://663e7a53e1913c476797c189.mockapi.io/exclusive', formData);
    ...
    const deleteItem = async (id) => {
        try {
            await axios.delete(`https://663e7a53e1913c476797c189.mockapi.io/exclusive/${id}`);
    ...
    const updateItem = async () => {
        try {
            await axios.put(`https://663e7a53e1913c476797c189.mockapi.io/exclusive/${editingItemId}`, formData);
